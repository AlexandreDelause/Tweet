            ...
            $following = $dbh->prepare("SELECT * FROM `follow` WHERE `id_followers` = :id");
                ...
                <div class="bubble-container">
                    <div class="bubble">
                        ...
                        <h3 id="h3twet">'.htmlspecialchars($fol["nom"]).'</h3><p id="datetw">'.htmlspecialchars($fol["date_ins"]).'</p>                  
